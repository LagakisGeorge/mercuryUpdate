...
Public Class Form1
    ...
    Dim ftp As String = "ftp://62.103.69.140:50001"




    Private Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles download.Click
    ...
    Sub down()
        ...
        CLIENT.DownloadFile(ftp + "/mercury.zip", gPath + "\mercury.zip")
    ...
    Private Sub Timer1_Tick(ByVal sender As Object, ByVal e As EventArgs) Handles Timer1.Tick
        If File.Exists(gPath + "\merc.zip") Then
            ...
            'ProgressBar1.Value = Math.Val(Me.Text)
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            CLIENT.DownloadFile(ftp + "/mercury/update.inf", gPath + "\upd.txt")
